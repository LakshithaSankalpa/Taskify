...
import com.example.taskifytodoapp.databinding.ActivityMainBinding;
...
//        });
        binding.appBarMain.fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"info@lakshithasankalpa.com"});
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_about, R.id.nav_help)
